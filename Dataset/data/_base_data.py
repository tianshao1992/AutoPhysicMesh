...
class BasicData(abc.ABC):
    ...
    def concat(self,
        ...
        pass
        return NotImplementedError("concat not implemented yet!")
    ...
    def save_file(self, file: str, file_type: str):
        """
        ...
        if file_type == "csv" or file_type == "txt":
            ...
            self.data.to_json(file)
        elif file_type == "excel":
            self.data.to_excel(file)
        else:
            raise ValueError("save_type only support csv/txt, json and excel!")

    def load_file(self, file: str, file_type: str):
        r"""
