...
def get_dataloader(all_config):
    ...
    train_datasets = {'res': dataset(subset_name='res'),
                      'inflow': dataset(subset_name='inflow'),
                      'outflow': dataset(subset_name='outflow'),
                      'wall': dataset(subset_name='wall'),
                      'cylinder': dataset(subset_name='cylinder')
    }
    ...
    valid_datasets = {'all': dataset(subset_name='all', train_mode=False),
                      'cylinder': dataset(subset_name='cylinder', train_mode=False),
                      'inflow': dataset(subset_name='inflow', train_mode=False)}
