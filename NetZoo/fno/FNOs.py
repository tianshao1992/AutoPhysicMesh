...
from NetZoo.fno.spectral_layers import SpectralConv1d, SpectralConv2d, SpectralConv3d
from NetZoo.fno.basic_operators import channel_permute, spatial_padding
